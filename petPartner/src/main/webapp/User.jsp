...
<html lang="en">
  ...
  <body>  
	...
	<div class="container-fluid">
      ...
      <h2>仅显示通过本网站所领养的宠物</h2>
      
      <!-- 页面详情 -->
      <div class=" row animal-info">
        <form class="row g-3">
           <c:forEach items="${mypet}" var="pet">
	          <div class="col-md-6">
	            <div class="Img">
	              <img alt="" src="${pet.img}">
	            </div>
	            <div class="info">
	              <h3><small>品种：</small>${pet.breed}</h3>
	                <div class="information">
		                <div>
		                  <div  class="tag">
			                <div><span><small>编号:</small></span></div>
			                <div><span>${pet.id} </span></div>
			              </div>
			              <div  class="tag">
			                <div><span><small>性别：</small></span></div>
			                <div><span>${pet.sex}</span></div>
			              </div>
			              <div  class="tag">
			                <div><span><small>年龄：</small></span></div>
			                <div><span>${pet.gender }</span></div>
			              </div>
			              <div  class="tag">
			                <div><span><small>健康状况：</small></span></div>
			                <div><span>${pet.status }</span></div>
			              </div>
		                </div>
		             </div>
	            </div>
